        ...
        <div class="card-body">
            ...
            @if(isset($menu)) @method('PUT') @endif
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="route" class="form-control" placeholder="Route name" value="{{ $menu->route ?? '' }}">
                </div>

                <div class="mb-3">
                    <label for="menuIcon">Icon</label>
                    <input type="text" name="icon" class="form-control" placeholder="fas fa-users" value="{{ $menu->icon ?? '' }}">
                </div>
